...
<head>
    <title>FlytLabs | Xobus, experimental artificial intelligence</title>
    ...
    <meta name="description" content="Xobus | experimental artificial intelligence">
...
<body>
    ...
    <main>
        <section>
            <div class="text">
                <h1>Xobus - Aesthetica</h1>
                <p>
                    The AI that feeds creativity, makes choices, then learns from them. Currently still under
                    development.
                </p>
                <button onclick="location.href='aesthetica.php'">Learn More</button>
            </div>
            <div class="img-container">
                <img src="../Assets/llustrations/xobus/xobus-1.svg" alt="Aesthetica Image">
            </div>
        </section>
        <section>
            <div class="img-container">
                <img src="../Assets/llustrations/xobus/xobus-2.svg" alt="Experimental Image">
            </div>
            <div class="text">
                <h1>Xobus - Experimental</h1>
                <p>
                    Coming Soon. Anticipated white paper date: September 14, 2020.
                </p>
            </div>
        </section>
    </main>
